...
export async function POST(request: Request) {
  ...
  try {
    ...
    const prompts: Record<string, { prompt: string; field: string; tokens: number }> = {
      ...
      content: { field: 'content_data', tokens: 4000, prompt: `${bizCtx}\n\nBuat 30 konten sosmed baru. JSON: { "content_pillars": [{"name":"...","percentage":40,"description":"..."},{"name":"...","percentage":30,"description":"..."},{"name":"...","percentage":20,"description":"..."},{"name":"...","percentage":10,"description":"..."}], "posts": [{"day":1,"pillar":"...","platform":"Instagram","type":"Carousel","caption":"...","hashtags":"..."}] } Ã¢ÂÂ buat 30 posts hari 1-30.` },
      ...
      checklist: { field: 'checklist_data', tokens: 3000, prompt: `${bizCtx}\n\nBuat checklist 30 hari baru. JSON: { "weeks": [{"week":1,"title":"...","tasks":[{"id":"w1t1","task":"...","category":"Brand","priority":"high","estimated_hours":2}]},{"week":2,"title":"...","tasks":[]},{"week":3,"title":"...","tasks":[]},{"week":4,"title":"...","tasks":[]}] } Ã¢ÂÂ 8-10 tasks per minggu.` },
